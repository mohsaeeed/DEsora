...
var p2q2q1 = '1. Level of Consciousness';
var p2q2q2 = '2. Month and Age';
var p2q2q3 = '3. Blink Eyes and Squeeze Hands';
var p2q2q4 = '4. Horizontal Extra-Ocular Movements';
var p2q2q5 = '5. Visual Fields';
var p2q2q6 = '6. Facial Palsy';
var p2q2q7 = '7. Left Arm Motor Drift';
var p2q2q8 = '8. Right Arm Motor Drift';
var p2q2q9 = '9. Left Leg Motor Drift';
var p2q2q10 = '10. Right Leg Motor Drift';
var p2q2q11 = '11. Limb Ataxia';
var p2q2q12 = '12. Sensation';
var p2q2q13 = '13. Language/Aphasia';
var p2q2q14 = '14. Dysarthria';
var p2q2q15 = '15. Extinction/Inattention';


class StrokeStepTwo extends Component {
    ...
    <View style={s.wrapper}>
        ...
        <ScrollView style={s.gridTainer}>
            <Form ref="conciousLevel" style={s.pickerTainer}>
              <PickerField ref='conciousLevel' placeholder='+0' value="+0" label={p2q2q1} style={s.optionText}
                  options={{
            ...
            <Form ref="monthAge" style={s.pickerTainer}>
              <PickerField ref='monthAge' placeholder='+0' value="+0" label={p2q2q2} style={s.optionText}
                  options={{
            ...
            <Form ref="blinkSqueeze" style={s.pickerTainer}>
              <PickerField ref='blinkSqueeze' placeholder='+0' value="+0" label={p2q2q3} style={s.optionText}
                  options={{
            ...
            <Form ref="ocular" style={s.pickerTainer}>
              <PickerField ref='ocular' placeholder='+0' value="+0" label={p2q2q4} style={s.optionText}
                  options={{
                    0: 'Normal +0',
            ...
            <Form ref="visualFields" style={s.pickerTainer}>
              <PickerField ref='visualFields' placeholder='+0' value="+0" label={p2q2q5} style={s.optionText}
                  options={{
                    0: 'No visual loss +0',
            ...
            <Form ref="facialPalsy" style={s.pickerTainer}>
              <PickerField ref='facialPalsy' placeholder='+0' value="+0" label={p2q2q6} style={s.optionText}
                  options={{
                    0: 'Normal symmetry +0',
                    1: 'Minor paralysis +1',
            ...
            <Form ref="leftArm" style={s.pickerTainer}>
              <PickerField ref='leftArm' placeholder='+0' value="+0" label={p2q2q7} style={s.optionText}
                  options={{
            ...
            <Form ref="rightArm" style={s.pickerTainer}>
              <PickerField ref='rightArm' placeholder='+0' value="+0" label={p2q2q8} style={s.optionText}
                  options={{
                    0: 'No drift for 10 seconds +0',
                    1: "Drift but doesn't hit bed +1",
                    2: 'Drift hits bed +2',
            ...
            <Form ref="leftLeg" style={s.pickerTainer}>
              <PickerField ref='leftLeg' placeholder='+0' value="+0" label={p2q2q9} style={s.optionText}
                  options={{
                    0: 'No drift for 10 seconds +0',
                    1: "Drift but doesn't hit bed +1",
                    2: 'Drift hits bed +2',
            ...
            <Form ref="rightLeg" style={s.pickerTainer}>
              <PickerField ref='rightLeg' placeholder='+0' value="+0" label={p2q2q10} style={s.optionText}
                  options={{
                   0: 'No drift for 10 seconds +0',
                    1: "Drift but doesn't hit bed +1",
                    2: 'Drift hits bed +2',
            ...
            <Form ref="limbAtaxia" style={s.pickerTainer}>
              <PickerField ref='limbAtaxia' placeholder='+0' value="+0" label={p2q2q11} style={s.optionText}
                  options={{
                    0: 'No ataxia +0',
                    1: 'Ataxia 1 limb +1',
            ...
            <Form ref="sensation" style={s.pickerTainer}>
              <PickerField ref='sensation' placeholder='+0' value="+0" label={p2q2q12} style={s.optionText}
                  options={{
            ...
            <Form ref="languageAphasia" style={s.pickerTainer}>
              <PickerField ref='languageAphasia' placeholder='+0' value="+0" label={p2q2q13} style={s.optionText}
                  options={{
                    0: 'Normal +0',
            ...
            <Form ref="dysarthia" style={s.pickerTainer}>
              <PickerField ref='dysarthia' placeholder='+0' value="+0" label={p2q2q14} style={s.optionText}
                  options={{
                    0: 'Normal +0',
            ...
            <Form ref="extinctionInattention" style={s.pickerTainer}>
              <PickerField ref='extinctionInattention' placeholder='+0' value="+0" label={p2q2q15} style={s.optionText}
                  options={{
                    0: 'No abnormality +0',
