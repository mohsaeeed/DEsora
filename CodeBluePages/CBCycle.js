...
class CBCycle extends Component {
    ...
    <View style={styles.wrapper}>
        ...
        <View style={styles.headerwrapper}>
            <View style={styles.headernavigation}>
                ...
                <View style={styles.buttonWrap}>
                    <Text style={styles.title}>Heart Rythm</Text>
                </View>
                <View style={styles.divider}>
        ...
        <View style={styles.contentwrapper}>
            <Text style={styles.welcome}>Check Pulse</Text>
            <Text style={styles.welcome}>Restart compressions in: NOW</Text>
            <TouchableHighlight onPress={ this.navigate.bind(this, 'CBHasPulse') } style={styles.optionButton}>
                <Text style={styles.optionText}>Has Pulse (Gasping)</Text>
            </TouchableHighlight>
            <TouchableHighlight onPress={ this.navigate.bind(this, 'CBVFIB') } style={styles.optionButton}>
                <Text style={styles.optionText}>VFIB</Text>
            </TouchableHighlight>
            <TouchableHighlight onPress={ this.navigate.bind(this, 'CBVTACH') } style={styles.optionButton}>
                <Text style={styles.optionText}>VTACH</Text>
            </TouchableHighlight>
            <TouchableHighlight onPress={ this.navigate.bind(this, 'CBPEA') } style={styles.optionButton}>
                <Text style={styles.optionText}>PEA</Text>
            </TouchableHighlight>
            <TouchableHighlight onPress={ this.navigate.bind(this, 'CBAsystole') } style={styles.optionButton}>
                <Text style={styles.optionText}>Asystole</Text>
            </TouchableHighlight>
