...
class CBPulse extends Component {
  ...
  render() {
    ...
    <View style={styles.wrapper}>
        ...
        <View style={styles.contentwrapper}>
            <TouchableHighlight onPress={ this.navigate.bind(this, 'CBCPR') } style={styles.optionButton}>
                <Text style={styles.optionText}>No Pulse</Text>
            </TouchableHighlight>
            <TouchableHighlight onPress={ this.navigate.bind(this, 'CBEndCB') } style={styles.optionButton}>
                <Text style={styles.optionText}>Pulse</Text>
            </TouchableHighlight>
        </View>
