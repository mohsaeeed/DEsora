...
class CBFirstSteps extends Component {
    ...
    <View style={styles.wrapper}>
        ...
        <View style={styles.headerwrapper}>
            <View style={styles.headernavigation}>
                <View style={styles.buttonWrap}>
                    <TouchableHighlight onPress={ this.navigate.bind(this, 'CBBreathing') } style={styles.button}>
                        <Text>Back</Text>
                    </TouchableHighlight>
                </View>
                ...
                <View style={styles.buttonWrap}>
                    <Text style={styles.title}>First Steps</Text>
                </View>
                <View style={styles.divider}>
        ...
        <View style={styles.contentwrapper}>
            <View style={styles.optionSetContainer}>
                <Text style={styles.optionSetTitle}>Call Code Blue</Text>
            </View>
            
            <View style={styles.optionSetContainer}>
                <Text style={styles.optionSetTitle}>Get AED or Defibrillator</Text>
            </View>
            
            <View style={styles.optionSetContainer}>
                <Text style={styles.optionSetTitle}>Call Others to Help</Text>
            </View>
            
            <TouchableHighlight onPress={ this.navigate.bind(this, 'CBPulse') } style={styles.button}>
                <Text>Next</Text>
            </TouchableHighlight>
        </View>
