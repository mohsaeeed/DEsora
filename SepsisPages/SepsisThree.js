...
class SepsisThree extends Component {
    ...
    <View style={s.wrapper}>
        ...
        <View style={s.contentwrapper}>
            ...
            <View style={s.optionButton}>
                <Image
                  source={require('../assets/states/sepsis/stepOneDone.png')}
                />
            </View>
            <View style={s.optionButton}>
                <Image
                  source={require('../assets/states/sepsis/stepTwoDone.png')}
                />
            </View>
            <TouchableHighlight onPress={ this.navigate.bind(this, 'SepsisStepThree') } style={s.optionButton}>
                <Image
                  source={require('../assets/states/sepsis/stepThreeStart.png')}
                />
            </TouchableHighlight>
        </View>
