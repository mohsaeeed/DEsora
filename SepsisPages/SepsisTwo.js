...
class SepsisTwo extends Component {
  ...
  render() {
    ...
    <View style={s.wrapper}>
        ...
        <View style={s.contentwrapper}>
            ...
            <TouchableHighlight onPress={ this.navigate.bind(this, 'SepsisStepTwo') } style={s.optionButton}>
                <Image
                  source={require('../assets/states/sepsis/stepTwoStart.png')}
                />
            </TouchableHighlight>
            <View style={s.optionButton}>
                <Image
