...
class SevereSepsisTreatment extends Component {
        ...
        <View style={s.contentwrapper}>
            <View style={s.timerWrap}>
              ...
              <ScrollView style={s.gridTainer}>
                ...
                <View style={s.optionSetContainer}>
                    <Text style={s.minorText}>Patient has Hypotension after initial fluid resuscitation, MAP UNDER 65?</Text>
                </View>
                <Form ref='persistenHypotensionSevereSepsis' style={s.optionSetInputYN}>
                  <View style={s.yesNoContainer}>
                    <Text style={s.yesNo}>No</Text>
                    <SwitchField label='' ref="persistenHypotensionSevereSepsis"/>
...
export default SevereSepsisTreatment
