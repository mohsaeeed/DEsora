...
let { View, StyleSheet, TextInput, Text, PickerIOS, Dimensions} = ReactNative;
var {height, width}     = Dimensions.get('window');


import {PickerComponent} from '../lib/PickerComponent';

export class PickerFieldBasic extends React.Component{
  setValue(value){
  ...
  render(){
    return(<PickerComponent
      ...
      let formStyles = StyleSheet.create({
        ...
        alignRight:{
           marginTop:0, position:'absolute', right: 0
        },
        noBorder:{
          borderTopWidth: 0,
          borderBottomWidth: 0
        ...
        fieldValue:{
          ...
          height: 55,
          width: width / 4 - 1,
          color: 'rgba(0,43,55,1)',
          alignItems: 'flex-end',
          borderLeftWidth:1,
          borderLeftColor: 'lightgray',
          backgroundColor: 'rgba(246, 240, 222, 1)',
        },
        fieldText:{
          fontSize: 18,
          paddingLeft: 10,
