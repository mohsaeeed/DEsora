...
class BugFix extends React.Component{
  constructor(props){
    super(props);
    this.state = {
      formData:{}
            ...
            <ScrollView style={s.gridTainer}>
                <View style={s.optionSetContainer11}>
                    <View style={s.optionSetContainer02}>
                        <Text style={s.optionSetTitleBold}>Bug Report Form</Text>
                    </View>
                            ...
                            <Form
                                ...
                                label="Bug Fix Form">
                                  <InputField
                                    ...
                                    helpText='Please be thorough with your bug explanation' />
                            </Form>
                        </View>
                    </View>
                            ...
                            <TouchableHighlight onPress={ this.navigate.bind(this, 'Main') } style={styles.button}>
                                <View style={s.gridFormBorderless}>
                                    <View style={s.gridFormThin}>
                                        <Text style={s.optionSetFontBold}>Submit Bug</Text>
                                    </View>
